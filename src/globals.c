...
SDL_Texture *COMMAND_ROOM_MI = NULL;
SDL_Texture *COMMAND_ROOM_MI_M = NULL;
SDL_Texture *MIMIC_CORRIDOR = NULL;
SDL_Texture *MIMIC_CORRIDOR_M = NULL;
SDL_Texture *MIMIC_CORRIDOR_MI = NULL;
SDL_Texture *MIMIC_CORRIDOR_MI_M = NULL;
IMG_Animation *STATIC = NULL;
SDL_Texture *STATIC_CAM = NULL;
...
SDL_Texture *FRONT_WALL = NULL;
SDL_Texture *FRONT_WALL_M = NULL;
SDL_Texture *FRONT_WALL_MI = NULL;
SDL_Texture *FRONT_WALL_MI_M = NULL;
SDL_Texture *HALLWAY = NULL;
SDL_Texture *HALLWAY_M = NULL;
SDL_Texture *HALLWAY_MI = NULL;
SDL_Texture *HALLWAY_MI_M = NULL;
IMG_Animation *monster_death = NULL;
IMG_Animation *mimic_death = NULL;
